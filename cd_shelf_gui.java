    ...
    public static void main(String[] args) {
            ...
            public void tableChanged(javax.swing.event.TableModelEvent evt) {
                ...
                if (column == 0) {
                    if (shelf.search(table.getValueAt(row, 0).toString()) == -1) {
                        shelf.add(new cd(table.getValueAt(row, 0).toString(), table.getValueAt(row, 1).toString(),
        ...
        add.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                int tracks = Integer.parseInt(JOptionPane.showInputDialog("Enter the number of tracks on the cd"));
        ...
        remove.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                int i = Integer.parseInt(JOptionPane.showInputDialog("Enter the index of the cd you want to remove"));
                shelf.remove(i);
                // update the table
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                if (result != -1) {
                    JOptionPane.showMessageDialog(null,
                            shelf.getCds()[result].getTitle() + " " + shelf.getCds()[result].getArtist() + " "
                                    + shelf.getCds()[result].getTracks() + " " + shelf.getCds()[result].getPrice());
                }
